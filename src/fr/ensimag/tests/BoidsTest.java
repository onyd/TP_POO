...
public class BoidsTest {
	public static void main(String[] args) {
		...
		float r = 5.0f;
		float maxSpeed = 5.0f;
		BoidGroup preys1 = new BoidGroup(1, 200, r, 2*r, 40.0f, 180.0f, maxSpeed, Color.BLUE);
		BoidGroup preys2 = new BoidGroup(1, 200, r, 2*r, 40.0f, 180.0f, maxSpeed, Color.GREEN);
		PredatorGroup predators = new PredatorGroup(1, 50, r, 2*r, 40.0f, 180.0f, maxSpeed, Color.ORANGE, preys1, preys2);
